...
echo "INSERT INTO Location (id, Name) VALUES (1, 'DSR');" > "$SCRIPT_PATH/data/Location.sql"
echo "INSERT INTO Location (id, Name) VALUES (2, 'Nordhavn');" >> "$SCRIPT_PATH/data/Location.sql"
