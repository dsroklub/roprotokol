...
$s="
SELECT CONCAT(mf.FirstName,' ',mf.LastName) as sender, DATE_FORMAT(forum_message.created,'%Y-%m-%dT%T') as created, forum_message.forum as source, 'forum' as type,42 as msgid,subject, forum_message.message as body
...
UNION 
SELECT CONCAT(mf.FirstName,' ',mf.LastName) as sender, DATE_FORMAT(event_message.created,'%Y-%m-%dT%T') as created, event.name as source, 'event' as type, event_message.id as msgid,subject, event_message.message as body
