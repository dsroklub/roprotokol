...
$s="
SELECT CONCAT(mf.FirstName,' ',mf.LastName) as name, forum_message.created, forum_message.forum as source, subject, forum_message.message as body
...
UNION 
SELECT CONCAT(mf.FirstName,' ',mf.LastName) as name, event_message.created, event.name as source, subject, event_message.message as body
