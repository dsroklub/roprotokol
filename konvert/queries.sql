...
SELECT Rostat_BeregnRodistance.MedlemID, Medlem.Medlemsnr AS Medlemsnr, CONCAT(fornavn," ",efternavn) AS Navn, Rostat_BeregnRodistance.Rodistance, Rostat_BeregnRodistance.Antal_ture, ROUND(Rodistance/Antal_ture*10)/10 AS Gennemsnitslængde
...
SELECT Rostat_BeregnRodistance_kajak.MedlemID, medlemsnr AS Medlemsnr_, CONCAT(fornavn," ",efternavn) AS Navn, Rostat_BeregnRodistance_kajak.Rodistance, Rostat_BeregnRodistance_kajak.Antal_ture, ROUND(Rodistance/Antal_ture*10)/10 AS Gennemsnitslængde
...
SELECT Rostat_BeregnRodistance_robaad.MedlemID, medlemsnr AS Medlemsnr_, CONCAT(fornavn," ",efternavn) AS Navn, Rostat_BeregnRodistance_robaad.Rodistance, Rostat_BeregnRodistance_robaad.Antal_ture, ROUND(Rodistance/Antal_ture*10)/10 AS Gennemsnitslængde
...
SELECT Rostat_Rangorden.MedlemID, Rostat_Rangorden.Medlemsnr, Rostat_Rangorden.Navn, Rostat_Rangorden.Rodistance, Rostat_Rangorden.Antal_ture, Rostat_Rangorden.Gennemsnitslængde
...
SELECT Båd.Navn, Gruppe.Navn AS Bådtype, if(Ud>0,"Ja","Nej") AS Paa_vandet, qBoatsOnWater3.ForvInd, qBoatsOnWater3.Styrmand, qBoatsSkadet.grad AS Skadet, IF(Grad>2 Or ud>0 Or MotionPlus=1,"Nej","Ja") AS Tilgængelig
...
SELECT Båd.Navn, Gruppe.GruppeNr, Gruppe.Navn AS Bådtype, IF(Ud>0,"Ja","Nej") AS Paa_vandet, qBoatsOnWater3.ForvInd, qBoatsOnWater3.Styrmand, qBoatsSkadet.grad AS Skadet, IF(Grad>2 Or ud>0 Or MotionPlus=1,"Nej","Ja") AS Tilgængelig
FROM (((Gruppe RIGHT JOIN Båd ON Gruppe.GruppeID = Båd.FK_GruppeID) LEFT JOIN BådKategori ON Gruppe.FK_BådKategoriID = BådKategori.BådKategoriID) LEFT JOIN qBoatsOnWater3 ON Båd.BådID = qBoatsOnWater3.FK_BådID) LEFT JOIN qBoatsSkadet ON Båd.BådID = qBoatsSkadet.FK_BådID
...
SELECT Båd.Navn, IF(Ud>0,"Ja","Nej") AS Paa_vandet, qBoatsOnWater3.ForvInd, qBoatsOnWater3.Styrmand, qBoatsSkadet.grad AS Skadet, IF(Grad>2 Or ud>0 Or MotionPlus=1,"Nej","Ja") AS Tilgængelig
FROM (((Gruppe RIGHT JOIN Båd ON Gruppe.GruppeID = Båd.FK_GruppeID) LEFT JOIN BådKategori ON Gruppe.FK_BådKategoriID = BådKategori.BådKategoriID) LEFT JOIN qBoatsOnWater3 ON Båd.BådID = qBoatsOnWater3.FK_BådID) LEFT JOIN qBoatsSkadet ON Båd.BådID = qBoatsSkadet.FK_BådID
