...
$s="SELECT Boat.id as boatid, Boat.Name AS boat, OutTime as outtime, ExpectedIn as expectedintime, Trip.Destination as destination, Trip.id, TripType.Name AS triptype ".
