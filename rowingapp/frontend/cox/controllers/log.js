...
angular.module('coxApp').controller(
  'logCtrl',
  ['$scope', '$routeParams', 'DatabaseService', '$filter', 'ngDialog','orderByFilter','$log','$timeout',logCtrl]);

function logCtrl ($scope, $routeParams, DatabaseService, $filter, ngDialog, orderBy,$log, $timeout) {
  $scope.dbready=false;
  $scope.dbgrace=true;
